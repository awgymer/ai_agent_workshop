//! `mytools subtract` (#9). Stub: validates the command line, then exits 1.
...
const FLAGS: &[Flag] = &[
    Flag::new("a", Kind::Str),
    Flag::new("b", Kind::Str),
    Flag::new("A", Kind::Switch),
    Flag::new("N", Kind::Switch),
...
const SPEC: Spec = Spec {
    usage: "usage: mytools subtract [OPTIONS] -a <bed/gff/vcf/bam> -b <bed/gff/vcf/bam>",
    flags: FLAGS,
    required: &["a", "b"],
};
